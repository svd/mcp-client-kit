...
class TeamOrgSummary(TypedDict, total=False):
    org: str
...
async def get_teams(caller: McpCaller, *, user: str | None = None) -> list[TeamOrgSummary]:
    ...
    if user is not None:
        args["user"] = user
    return cast("list[TeamOrgSummary]", await caller.call(SERVER, "get_teams", args))
