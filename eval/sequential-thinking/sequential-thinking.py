...
class ThoughtProgress(TypedDict, total=False):
    thoughtNumber: int
    totalThoughts: int
...
async def sequentialthinking(caller: McpCaller, *, thought: str, thoughtNumber: int, totalThoughts: int, nextThoughtNeeded: bool | None = None, isRevision: bool | None = None, revisesThought: int | None = None, branchFromThought: int | None = None, branchId: str | None = None, needsMoreThoughts: bool | None = None) -> ThoughtProgress:
    ...
    """
    args: dict[str, Any] = {"thought": thought, "thoughtNumber": thoughtNumber, "totalThoughts": totalThoughts}
    if nextThoughtNeeded is not None:
        args["nextThoughtNeeded"] = nextThoughtNeeded
    ...
    return cast("ThoughtProgress", await caller.call(SERVER, "sequentialthinking", args))
