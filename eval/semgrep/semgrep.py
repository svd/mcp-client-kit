...
class SastFinding(TypedDict, total=False):
    id: int
    created_at: str
    ref: str
    syntactic_id: str
...
class ScaFinding(TypedDict, total=False):
    id: int
    created_at: str
    ref: str
    syntactic_id: str
...
@overload
async def semgrep_findings(caller: McpCaller, *, issue_type: Literal['ISSUE_TYPE_SAST'], repos: list[str] | None = None, status: Literal['ISSUE_TAB_OPEN', 'ISSUE_TAB_CLOSED', 'ISSUE_TAB_IGNORED', 'ISSUE_TAB_REVIEWING', 'ISSUE_TAB_FIXING'] | None = None, severities: Any | None = None, confidence: Any | None = None, source: Any | None = None, reachabilities: Any | None = None, validation_states: Any | None = None, dataflow_only: bool | None = None, interfile_only: bool | None = None, refs: list[str] | None = None, limit: int | None = None) -> list[SastFinding]: ...

@overload
async def semgrep_findings(caller: McpCaller, *, issue_type: Literal['ISSUE_TYPE_SCA'], repos: list[str] | None = None, status: Literal['ISSUE_TAB_OPEN', 'ISSUE_TAB_CLOSED', 'ISSUE_TAB_IGNORED', 'ISSUE_TAB_REVIEWING', 'ISSUE_TAB_FIXING'] | None = None, severities: Any | None = None, confidence: Any | None = None, source: Any | None = None, reachabilities: Any | None = None, validation_states: Any | None = None, dataflow_only: bool | None = None, interfile_only: bool | None = None, refs: list[str] | None = None, limit: int | None = None) -> list[ScaFinding]: ...

async def semgrep_findings(caller: McpCaller, *, issue_type: str, repos: list[str] | None = None, status: Literal['ISSUE_TAB_OPEN', 'ISSUE_TAB_CLOSED', 'ISSUE_TAB_IGNORED', 'ISSUE_TAB_REVIEWING', 'ISSUE_TAB_FIXING'] | None = None, severities: Any | None = None, confidence: Any | None = None, source: Any | None = None, reachabilities: Any | None = None, validation_states: Any | None = None, dataflow_only: bool | None = None, interfile_only: bool | None = None, refs: list[str] | None = None, limit: int | None = None) -> list[SastFinding | ScaFinding]:
    ...
    """
    args: dict[str, Any] = {"issue_type": issue_type}
    ...
    return cast("list[SastFinding | ScaFinding]", _dig_list(result, ('findings', )))
