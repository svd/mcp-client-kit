...
class RegionalAvailability(TypedDict, total=False):
    products: dict
    service_apis: dict
    cfn_resources: dict
    next_token: str
...
async def aws___get_regional_availability(caller: McpCaller, *, resource_type: str, regions: list[str] | None = None, filters: list[str] | None = None, next_token: str | None = None, region: str | None = None) -> RegionalAvailability:
    ...
    return cast("RegionalAvailability", _dig(result, ('content', 'result', )))
