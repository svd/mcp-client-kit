...
async def get_structured_content(caller: McpCaller, *, location: Literal['New York', 'Chicago', 'Los Angeles']) -> WeatherRecord:
    ...
    return cast("WeatherRecord", await caller.call(SERVER, "get-structured-content", args))
