...
class WeatherReport(TypedDict, total=False):
    temperature: int
    conditions: str
    humidity: int
...
async def get_structured_content(caller: McpCaller, *, location: Literal['New York', 'Chicago', 'Los Angeles']) -> WeatherReport:
    ...
    return cast("WeatherReport", await caller.call(SERVER, "get-structured-content", args))
