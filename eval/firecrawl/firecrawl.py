...
async def firecrawl_monitor_list(caller: McpCaller, *, limit: int | None = None, offset: int | None = None) -> MonitorList:
    ...
    if offset is not None:
        args["offset"] = offset
    return cast("MonitorList", await caller.call(SERVER, "firecrawl_monitor_list", args))
