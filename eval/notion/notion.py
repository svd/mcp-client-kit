...
class SidebarPageSummary(TypedDict, total=False):
    type: str
    url: str
    title: str


class RecentPageSummary(TypedDict, total=False):
    type: str
    url: str
    title: str
    icon: str
...
async def notion_list_favorite_pages(caller: McpCaller, *, limit: float | None = None, cursor: str | None = None) -> list[SidebarPageSummary]:
    ...
    return cast("list[SidebarPageSummary]", _dig_list(result, ('results', )))
...
async def notion_list_private_pages(caller: McpCaller, *, limit: float | None = None, cursor: str | None = None) -> list[SidebarPageSummary]:
...
async def notion_list_recent_pages(caller: McpCaller, *, limit: float | None = None, cursor: str | None = None) -> list[RecentPageSummary]:
    ...
    return cast("list[RecentPageSummary]", _dig_list(result, ('results', )))
